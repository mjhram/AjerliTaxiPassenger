package com.mjhram.ajerlitaxi.common.events;
...
public class ServiceEvents {
    ...
    public static class updateDrivers {
        public DriverInfo[] drvInfo;
        public int drvCount;
        public double lat_d, lng_d;
        public Location location;

        public updateDrivers(int driversCount, DriverInfo[] driverInfo, double lat_dw, double lng_dw, Location loc){
